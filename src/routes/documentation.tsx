      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Complete guide to the crypto trading signal tracking system — architecture, business
            logic, and API reference.
          </p>
        </div>
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            <div className="rounded-xl border bg-card p-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                SignalTracker is a production-grade full-stack application for tracking
                cryptocurrency trading signals. It integrates with Binance's live price feed to
                automatically evaluate signal status and calculate realized/unrealized ROI.
              </p>
              <p className="text-muted-foreground leading-relaxed">
                The system implements proper separation of concerns with Express.js backend (MVC
                pattern), React frontend with TanStack Router, and MongoDB for persistent storage.
              </p>
            </div>
            <div className="rounded-xl border bg-card p-8">
...
└── package.json`}
            ...
            <div className="grid gap-6 md:grid-cols-3">
              <div className="rounded-xl border bg-card p-6">
                ...
                <p className="text-sm text-muted-foreground">
                  Entry time can be up to 24 hours in the past. System evaluates against current
                  live price immediately.
                </p>
              </div>
              <div className="rounded-xl border bg-card p-6">
                ...
                <p className="text-sm text-muted-foreground">
                  Uses Mongoose findOneAndUpdate with status filter to prevent race conditions
                  during concurrent evaluations.
                </p>
              </div>
              <div className="rounded-xl border bg-card p-6">
                ...
                <p className="text-sm text-muted-foreground">
                  TARGET_HIT, STOPLOSS_HIT, and EXPIRED statuses are final. Cron skips non-OPEN
                  signals entirely.
                </p>
              </div>
            </div>
            ...
            <div className="rounded-xl border bg-card p-8">
              ...
              <div className="space-y-4">
                {[
                  ...
                  {
                    condition: "now > expiry_time (and no hit)",
                    status: "EXPIRED",
          ...
          <div className="mt-8 rounded-xl border border-destructive/50 bg-destructive/5 p-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Once a signal reaches TARGET_HIT, STOPLOSS_HIT, or EXPIRED, its status becomes
                  immutable. The cron worker only processes signals with status=OPEN, ensuring no
                  state regression.
                </p>
              </div>
            </div>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div className="rounded-xl border bg-card p-8">
              <h3 className="text-xl font-semibold mb-4 flex items-center gap-3">
                <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-bull/10 text-bull font-bold">
                  B
                </span>
                BUY Direction
              </h3>
              ...
              <p className="text-sm text-muted-foreground">
                Profit when price increases above entry. Example: Entry $65,000 → Current $70,000 ={" "}
                <span className="text-success font-semibold">(+) 7.69%</span>
              </p>
            </div>
            <div className="rounded-xl border bg-card p-8">
              <h3 className="text-xl font-semibold mb-4 flex items-center gap-3">
                <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-bear/10 text-bear font-bold">
                  S
                </span>
                SELL Direction
              </h3>
              ...
              <p className="text-sm text-muted-foreground">
                Profit when price decreases below entry. Example: Entry $70,000 → Current $65,000 ={" "}
                <span className="text-success font-semibold">(+) 7.14%</span>
              </p>
            </div>
          </div>
          <div className="mt-6 rounded-xl border bg-card p-6">
            <p className="text-sm text-muted-foreground">
              ROI is calculated in real-time for OPEN signals and displayed with 2 decimal
              precision. Upon reaching TARGET_HIT or STOPLOSS_HIT, ROI is permanently stored in{" "}
              <code className="bg-muted px-1.5 py-0.5 rounded">realized_roi</code>.
            </p>
          </div>
        </section>
  ...
  "expiry_time": "2026-05-02T08:00:00Z"
                    ...
                    <p className="text-sm text-muted-foreground">
                      <strong>Validation:</strong> Symbol checked against Binance; Entry time can be
                      up to 24h in past; Expiry &gt; Entry; Direction-aware price rules enforced.
                    </p>
                  </>
                ),
              },
              {
                ...
                body: (
                  <p className="text-sm text-muted-foreground">
                    Query params: <code>status</code>, <code>symbol</code>, <code>direction</code>,{" "}
                    <code>limit</code> (default 100), <code>sort</code> (default{" "}
                    <code>-created_at</code>). Returns: <code>200</code> +{" "}
              ...
              },
              {
                ...
                body: (
                  <p className="text-sm text-muted-foreground">
                    Returns: <code>200</code> + signal object with <code>current_price</code> and{" "}
                    <code>live_roi</code> (for OPEN signals). Returns <code>404</code> if not found.
                  </p>
                ),
              },
              {
                ...
                body: (
                  <p className="text-sm text-muted-foreground">
                    Returns: <code>{`{ id, status, current_price, realized_roi }`}</code>. Minimal
                    DB fields — no signal details.
                  </p>
                ),
              },
              {
