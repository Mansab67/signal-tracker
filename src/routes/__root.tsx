...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "SignalTracker — Crypto Trading Signal Tracker" },
      {
        name: "description",
        content:
          "Professional crypto trading signal tracker with live Binance prices, automatic status evaluation, and ROI tracking.",
      },
